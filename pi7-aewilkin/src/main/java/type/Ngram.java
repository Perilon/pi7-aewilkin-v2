...
/* First created by JCasGen Sun Oct 18 16:10:06 EDT 2015 */
package type;
...
public class Ngram extends ComponentAnnotation {
  ...
  */  
  ...
  /** getter for n - gets The value of n
   * @generated
  ...
  /** setter for n - sets The value of n 
   * @generated
  ...
  /** getter for tokens - gets The tokens that make up an ngram
   * @generated
   * @return value of the feature 
   */
  ...
  /** setter for tokens - sets The tokens that make up an ngram 
   * @generated
   * @param v value to set into the feature 
   */
  ...
  /** indexed getter for tokens - gets an indexed value - The tokens that make up an ngram
   * @generated
  ...
  /** indexed setter for tokens - sets an indexed value - The tokens that make up an ngram
   * @generated
  ...
  /** getter for toStringValue - gets The string representation of the ngram
   * @generated
   * @return value of the feature 
   */
  ...
  /** setter for toStringValue - sets The string representation of the ngram 
   * @generated
   * @param v value to set into the feature 
   */
